function QuizApp(props){
    return (
        <div className="w-1/2 flex flex-col justify-center mx-auto">
            ...
            <h3 className="font-semibold text-xl text-center">{props.projectname}</h3>

            <div className="w-135 h-50 flex flex-col justify-center mx-auto mt-5 border border-transparent rounded-md shadow-2xl ">
                <h3 className="ml-3.5 font-semibold">{props.quiz1}</h3>
                <div className="w-125 border border-transparent rounded-md mx-auto bg-red-300 mb-0.5"> <p className="ml-2">{props.answer1}</p> </div>
